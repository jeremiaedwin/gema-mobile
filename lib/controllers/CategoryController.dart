...
class CategoryController {
  Future<List<Category>> getCategory(String id) async {
    final String apiUrl = 'http://192.168.195.2:8080/api/category/read/all';
  ...
  Future<List<Category>> getDataDetail(String category_id) async {
    final apiUrl = Uri.parse('http://192.168.195.2:8080/api/category/read/all');
    ...
    if (response.statusCode == 200) {
      ...
      return data
          ...
          .where((category) => category.category_id == category_id)
          .toList();
    } else {

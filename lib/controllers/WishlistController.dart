...
class WishlistController {
  Future<List<Wishlist>> getWishlist(String id) async {
    ...
    final String apiUrl = 'http://192.168.10.2:8080/api/wishlist/read/all/$id';
    try {
  ...
  Future<void> addWishlist(String nim, String ad_id, String wishlist_id) async {
    //final apiUrl = Uri.parse('http://10.0.2.2:8080/api/wishlist/create');
    final apiUrl = Uri.parse('http://192.168.10.2:8080/api/wishlist/create');
